...
if __name__ == '__main__':
    ...
    n = len(sys.argv)
    if n <= 1:
        print("Script requires at least one argument from list: getURLCategories, addURLCategories, getBypassProxy, addBypassProxy, getAccessPolicy,createAccessPolicy")
